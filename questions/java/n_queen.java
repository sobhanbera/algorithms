...
Problem Statement:
    ...
    We need to find out all the possible arrangements in which N queens can be seated
    in each row and each column so that all queens are safe. The queen moves
    in 8 directions and can directly attack in these 8 directions only.
...
public class n_queen {
    ...
    //this function checks if the cell in which queen is to placed is safe or not.
